...
<body>
<div class="create">
<h1 align="center"><u>Create Admin Account</u></h1>
		  
		<form action="adminInfoInsert.php" method="post">
		...
		<a href="adminInfoInsert.php"><input type="submit" style="position:absolute;top:550px;left:570px;width:200px;" name="Create"></a>
