      ...
      <h1>Parking Spaces:</h1>
		   ...
		   <?php
		    ...
		    $loc=$_POST['location']; 
                        ...
                        $query = "SELECT distinct Location FROM parking WHERE Location like '%$loc%'";
                      ...
                      if(mysqli_num_rows($result)>0){
							...
							<form action="actionBookparking2.php" method="post">  
								
								<input type="radio" name="loca" value="<?php echo $c ?>">
							  ...
							  <a href="actionBookparking2.php"><br><input type="submit" value="Submit" name="submit"></a>
							   </form>
